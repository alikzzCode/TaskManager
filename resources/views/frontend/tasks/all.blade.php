 ...
 <div class="bg0 m-t-23 p-b-140">
    <div class="container">
        ...
        <div class="row isotope-grid">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item category{{ $task->category_id }}">
                <!-- Block2 -->
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="/{{ $task->source_url }}" alt="IMG-PRODUCT">
                    ...
                    <div class="block2-txt flex-w flex-t p-t-14">
                        <div class="block2-txt-child1 flex-col-l ">
                            <a href="{{ route('home.tasks.show', $task->id) }}" class="mtext-106 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                {{ $task->title }}
                            </a>

                            <span class="stext-105 cl3">
                                {{ $task->priority }} هزار تومان
                            </span>
                        </div>
                    </div>
                </div>
