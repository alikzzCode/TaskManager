                      ...
                      <form action="{{ route('admin.users.store') }}" method="post">
                        @csrf
                          <div class="card-body">
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          <label>رمز</label>
                                          <input type="password" class="form-control" name="password" placeholder="رمز را وارد کنید">
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="form-group">
                          ...
                          <div class="card-footer">
                              <button type="submit" class="btn btn-primary float-left">ایجاد کردن</button>
                          </div>
                      </form>
                  </div>
              </div>
